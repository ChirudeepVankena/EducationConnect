...
<head>
	...
	<style>
	    ...
	    .login-container {
	        ...
	        margin: 0 auto;
	        padding: 2.5rem;
	        background: rgba(255, 255, 240, 0.95); /* Very light cream background */
	        border-radius: 24px;
	    ...
	    .login-container h3 {
	        text-align: center;
	        margin-bottom: 2rem;
	        color: #fbc02d; /* Light yellow accent */
	        font-weight: 700;
	        font-size: 2rem;
	    ...
	    .form-control:focus {
	        border-color: #fbc02d; /* Strong yellow border on focus */
	        box-shadow: 0 0 0 4px rgba(251, 192, 45, 0.2); /* Yellow focus glow */
	    }
	    ...
	    .btn-login {
	        background: linear-gradient(135deg, #fbc02d 0%, #fff176 100%); /* Soft yellow gradient */
	        color: white;
	        border: none;
	        transition: all 0.3s ease;
	    }
	    ...
	    .btn-login:hover {
	        ...
	        box-shadow: 0 8px 20px rgba(251, 192, 45, 0.3); /* Yellow shadow */
	    }
