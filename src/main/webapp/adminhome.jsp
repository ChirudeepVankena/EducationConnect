...
<div class="container">
    <div class="content-box">
        ...
        <p>
            EduConnect is a comprehensive platform designed to transform how knowledge is shared through webinars and workshops. It offers a user-friendly interface, reliable technology, and end-to-end solutions for event management and participant engagement. With scalability and innovation at its core, EduConnect meets the evolving needs of the learning community.
        </p>
        <h2>Key Features</h2>
		...
		<ul class="features-list">
		           <li>
		               ...
		               <div>
						   ...
						   Intuitive and easy-to-use interface for hosts and attendees alike.
		               </div>
		           </li>
		           <li>
		               <i class="fas fa-chalkboard-teacher"></i>
		               <div>
						   ...
						   Built with scalable, secure, and robust solutions to handle events of any size.
		               </div>
		           </li>
		           <li>
		               <i class="fas fa-user-graduate"></i>
		               <div>
						   ...
						   Designed with adaptability and innovation at its core, ensuring it meets the evolving needs of the learning community.

		               </div>
		           </li>
		       </ul>

            Experience education reimagined through our powerful platform that puts learning first. EduConnect combines ease of use with powerful features to create an environment where knowledge thrives.
			Join us in reshaping education, one webinar at a time!
        </p>
...
<div class="footer">
    <p>&copy; Copyright © 2024 tej,chiru All rights reserved. | Empowering Education Through Technology</p>
</div>
